...
final List<String> COUNTRY_NAME = COUNTRIES.map((element) => element["name"]).cast<String>().toList();

String getCountryEmoji(String country) {
  return COUNTRIES.filter((element) => element["name"] == country).first["emoji"].toString();
}